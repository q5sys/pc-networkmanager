...
cpres.path=/usr/local/share/trueos/pc-netmanager/
cpres.files=resources/umts_stick

resperm.path=/usr/local/share/trueos/pc-netmanager/
resperm.extra=chmod 755 $(INSTALL_ROOT)/usr/local/share/trueos/pc-netmanager/umts_stick

dnsconf.path=/usr/local/share/trueos/conf
